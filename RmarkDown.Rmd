...
Como hemos podido observar a lo largo de las pruebas realizadas en este trabajo, las variables Anchura, Longitud, Grosor y Peso no han mostrado por si solas ni en modelos logísticos multiples, relaciones significativas con la variable Tipo. La única que se ha acercado a tener una relación significativa ha sido la Longitud, pero aunque estaba cerca, no llegaba a la cifra necesaria. Sin embargo, con la proporción longitud/anchura, una relación arqueologicamente adecuada, vemos que si se puede hablar de una relación significativa, aunque sea por poco. Por ello hice una media con los valores de Longitud_Anchura con respecto a 0 o 1. Con esto se observa que "blade"(1) se diferencia por tener más longitud que anchura. Especificamente, la anchura es dos tercios de la longitud. Esto choca con la teoría inicial, la cual tenía como idea que la longitud de las laminas suele ser el doble del ancho. Por un lado vemos que la media sigue dando una mayor longitud que anchura, pero por el otro es menor de lo esperado. Esto puede deberse a varias causas, para empezar puede ser el resultado de que el tamaño de la muestra a analizar no es lo suficientemente grande (se necesitarían más piezas). Otro motivo puede deberse a la cultura de la que proceden los instrumentos y el material del que están hechos (obsidiana), es decir, que quizás en la cultura procedente de los instrumentos, el tamaño característico de las laminas sea diferente. Y como último motivo, pero no menos importante, este resultado obtenido puede ser causa de que los materiales analizados no estén en perfectas condiciones y por ende, algunas piezas no están completas, si no que algunas podrían estar partidas.

Comparando con el resultado de mi compañera Inés, quien también realizó un estudio sobre piezas de obsidiana de la misma zona, observo que aunque los resultados de los ejercicios varían, también se encuentra con la característica de que "flake" tiene de media lo mismo de ancho que de largo y que "blade" tiene mayor longitud que anchura. Además, la variable Longitud es la única que muestra una relación significativa con la variable Tipo.

Por tanto, diría que el principal parámetro arqueométrico que permite diferenciar los "flake" de los "blade" es la Longitud, en mi caso se hace más claro con la proporción longitud/anchura. 
